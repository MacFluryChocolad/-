...
This readme.txt file for the PortInterface software version 2.0 
...
printed documentation or online Help.
   ...
   **How To Run the Application:
   ...
   ------
     ...
     -Base Address of the memroy is given in your Quartus System, So get it from there.
      Current version of PortInterface software supports ASCII character set only.
